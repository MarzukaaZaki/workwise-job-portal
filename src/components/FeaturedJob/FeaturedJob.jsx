...
const FeaturedJob = ({featuredJob}) => {
    const {id, companyLogo, jobTitle, companyName, jobType, workHours, location, salaryRange } = featuredJob;
    const navigate = useNavigate();
    return (
        <div>
            <div className='border border-gray-300 rounded p-5 mx-3 my-3'>
                ...
                <button className='border-indigo-400 bg-white text-indigo-500 ml-3'>{workHours}</button>
                <div className='mt-3'>
